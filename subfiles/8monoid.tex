...
\end{proposition}
\begin{proof}
	% https://q.uiver.app/#q=
	\[\begin{tikzcd}
		S & {S^{-a-c}S^{a+c}} & {S^{-a-c}S^a S^c} & {S^{-a-c}S^cS^a} & {S^{-a-c}S^{a+c}} \\
		& {S^{-a}S^{-c}S^{a-b}S^bS^c} & {S^{-a}S^{-c}S^cS^{a-b}S^b} && S \\
		{S^{-a-b-c}S^{a+b+c}} & {S^{-a}S^{-c}S^{-b}S^aS^bS^c} & {S^{-a}S^{-c}S^cS^{-b}S^{a}S^b} && {S^{-a-b}S^{a+b}} \\
		{S^{-a-b-c}S^{a}S^{b+c}} & {S^{-a-c}S^{-b}S^aS^{b}S^c} & {S^{-a-c}S^cS^{-b}S^aS^b} & {S^{-a-c}S^{c-b}S^aS^b} & {S^{-a-b}S^aS^b} \\
		{S^{-a-b-c}S^{b+c}S^a} & {S^{-a-c}S^{-b}S^{b}S^cS^a} & {S^{-a-c}S^cS^{-b}S^bS^a} & {S^{-a-c}S^{c-b}S^bS^a} & {S^{-a-b}S^bS^a} \\
		&& {S^{-a-c}S^cSS^a} \\
		& {S^{-a-c}SS^cS^a} && {S^{-a-c}S^cS^a} \\
		{S^{-a-b-c}S^{a+b+c}} && S && {S^{-a-b}S^{a+b}}
		\arrow["{\phi_{-a-c,a+c}}", from=1-1, to=1-2]
		\arrow["{S^{-a-c}\phi_{a,c}}", from=1-2, to=1-3]
		\arrow["{S^{-a-c}\tau}", from=1-3, to=1-4]
		\arrow["{S^{a-c}\phi^{-1}_{c,a}}", from=1-4, to=1-5]
		\arrow["{\phi^{-1}_{-a-c,a+c}}", from=1-5, to=2-5]
		\arrow["{\phi_{-a-b,a+b}}", from=2-5, to=3-5]
		\arrow["{S^{-a-b}\phi_{a,b}}", from=3-5, to=4-5]
		\arrow["{S^{-a-b}\tau_{S^a,S^b}}", from=4-5, to=5-5]
		\arrow["{S^{-a-b}\phi^{-1}_{b,a}}", from=5-5, to=8-5]
		\arrow["{S^{-a-b-c}\tau_{a,b+c}}"', from=4-1, to=5-1]
		\arrow["{\phi_{-a-b-c,a+b+c}}"', from=1-1, to=3-1]
		\arrow["{S^{-a-b-c}\phi_{a,b+c}}"', from=3-1, to=4-1]
		\arrow["{\phi_{-a,-c}\phi_{a-b,b}S^c}"{description}, from=1-3, to=2-2]
		\arrow["{S^{-a}S^{-c}\phi_{-b,a}S^bS^c}"', from=2-2, to=3-2]
		\arrow["{\phi_{-a-c,-b}S^a\phi_{b,c}}"', from=4-1, to=4-2]
		\arrow["{\phi_{-a,-c}S^{-b}S^aS^bS^c}"{description}, from=4-2, to=3-2]
		\arrow["{\phi_{-a-c,-b}\phi_{b,c}S^a}"', from=5-1, to=5-2]
		\arrow["{S^{-a-c}S^{-b}\tau_{S^bS^c,S^a}}"{description}, from=5-2, to=4-2]
		\arrow["{\phi_{-a-c}S^c\phi_{a-b,b}}"{description}, from=1-4, to=2-3]
		\arrow["{S^{-a}S^{-c}\tau_{S^{a-b}S^b,S^c}}"', from=2-2, to=2-3]
		\arrow["{S^{-a}S^{-c}S^c\phi_{-b,a}S^b}", from=2-3, to=3-3]
		\arrow["{S^{-a}S^{-c}\tau_{S^{-b}S^aS^b,S^c}}", from=3-2, to=3-3]
		\arrow["{S^{-a-c}\tau_{S^{-b}S^aS^b,S^c}}"', from=4-2, to=4-3]
		\arrow["{\phi_{-a,-c}S^cS^{-b}S^aS^b}"{description}, from=4-3, to=3-3]
		\arrow["{\phi_{-a-c,c-b}S^bS^a}", from=5-5, to=5-4]
		\arrow["{\phi_{-a-c,c-b}S^aS^b}"', from=4-5, to=4-4]
		\arrow["{S^{-a-c}S^{c-b}\tau}", from=4-4, to=5-4]
		\arrow["{S^{-a-c}\phi_{c,-b}S^aS^b}"', from=4-4, to=4-3]
		\arrow["{\phi_{-a-b,a+b}^{-1}}", from=8-5, to=8-3]
		\arrow["{S^{-a-b-c}\phi_{b+c,a}^{-1}}"', from=5-1, to=8-1]
		\arrow["{S^{-a-c}\tau_{S^{-b}S^{b},S^c}}"', from=5-2, to=5-3]
		\arrow["{S^{-a-c}S^cS^{-b}\tau}"{description}, from=4-3, to=5-3]
		\arrow["{S^{-a-c}\phi_{c,-b}S^bS^a}"', from=5-4, to=5-3]
		\arrow["{S^{-a-c}\phi_{-b,b}S^cS^a}", from=7-2, to=5-2]
		\arrow["{S^{-a-c}\tau_{S,S^c}S^a}"{description}, from=7-2, to=6-3]
		\arrow["{\phi_{-a-b-c,a+b+c}^{-1}}"', from=8-1, to=8-3]
		\arrow["{S^{-a-c}S^c\phi_{-b,b}S^a}"{description}, from=6-3, to=5-3]
		\arrow["{S^{-a-c}\phi_{c,0}S^a}"{description}, from=7-4, to=6-3]
		\arrow["{S^{-a-c}\phi_{0,c}S^a}", from=7-4, to=7-2]
		\arrow["{S^{-a-c}\phi_{c-b,b}S^a}"', from=7-4, to=5-4]
	\end{tikzcd}\]
\end{proof}
