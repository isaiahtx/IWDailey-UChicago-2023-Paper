...
\begin{proof}
	...
	It remains to show that if $X$ is cellular and $E$ is cellular flat commutative, then this map is an isomorphism. First we show this is an isomorphism in the case $X=S^a$ for some $a\in A$.
\end{proof}
