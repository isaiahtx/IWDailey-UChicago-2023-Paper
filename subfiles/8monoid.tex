...
\begin{proof}
	...
	Now, we claim that $\Phi$ is an inverse to the map $\Psi:E_*(E)\otimes_{\pi_*(E)}E_*(S^a)\to E_*(E\otimes S^a)$ constructed above. First, let $x:S^b\to E\otimes E\otimes S^a$ in $E_b(E\otimes S^a)$. We would like to show that $\Psi(\Phi(x))=x$. Consider the following diagram:
	% https://q.uiver.app/#q=
	\[\begin{tikzcd}
		& {S^b} & {S^{b-a}\otimes S^a} \\
		& {S^b\otimes S} & {S^b\otimes S^{-a}\otimes S^a} & {S^b\otimes S^{-a}\otimes S\otimes S^a} \\
		{E\otimes E\otimes S^a} & {E\otimes E\otimes S^a\otimes S} & {E\otimes E\otimes S^a\otimes S^{-a}\otimes S^a} \\
		& {E\otimes E\otimes S^a\otimes S^{-a}\otimes S^a} & {E\otimes E\otimes S^a\otimes S^{-a}\otimes S\otimes S^a} \\
		& {E\otimes E\otimes S\otimes S^a} & {E\otimes E\otimes S\otimes S\otimes S^a} \\
		{E\otimes E\otimes E\otimes S^a} && {E\otimes E\otimes S\otimes E\otimes S^a} & {E\otimes E\otimes S^a\otimes S^{-a}\otimes E\otimes S^a}
		\arrow["{x\otimes S^{-a}\otimes e\otimes S^a}", from=2-4, to=6-4]
		\arrow["{E\otimes \rho_E\otimes E\otimes S^a}", from=6-3, to=6-1]
		\arrow["{E\otimes \mu\otimes S^a}", from=6-1, to=3-1]
		\arrow["x"', from=1-2, to=3-1]
		\arrow["{\phi_{b-a,a}}", from=1-2, to=1-3]
		\arrow["{\phi_{b,-a}\otimes\phi_{0,a}}", from=1-3, to=2-4]
		\arrow["{x\otimes S^{-a}\otimes S\otimes S^a}", from=2-4, to=4-3]
		\arrow["{E\otimes E\otimes S^a\otimes \phi_{-a,0}\otimes S^a}", from=4-2, to=4-3]
		\arrow["{E\otimes E\otimes S^a\otimes \phi_{-a,a}}", from=3-2, to=4-2]
		\arrow["{E\otimes E\otimes \phi_{a,0}}"{description}, from=3-1, to=3-2]
		\arrow["{\phi_{b,0}}", from=1-2, to=2-2]
		\arrow["{x\otimes S}", from=2-2, to=3-2]
		\arrow["{E\otimes E\otimes S^a\otimes S^{-a}\otimes \phi_{0,a}}"{description}, from=3-3, to=4-3]
		\arrow["{E\otimes E\otimes S^a\otimes \phi_{-a,a}}", from=3-2, to=3-3]
		\arrow["{\phi_{b,-a}\otimes S^a}"', from=1-3, to=2-3]
		\arrow["{S^b\otimes S^{-a}\otimes \phi_{0,a}}"', from=2-3, to=2-4]
		\arrow["{x\otimes S^{-a}\otimes S^a}"', from=2-3, to=3-3]
	\arrow["{S^b\otimes\phi_{-a,a}}", from=2-2, to=2-3]
	\arrow["{E\otimes E\otimes S^a\otimes S^{-a}\otimes e\otimes S^a}", from=4-3, to=6-4]
	\arrow["{E\otimes E\otimes \phi_{a,-a}\otimes S^a}"', from=5-2, to=4-2]
	\arrow["{E\otimes E\otimes \phi_{0,a}}"', from=3-1, to=5-2]
	\arrow["{E\otimes E\otimes e\otimes S^a}"', from=5-2, to=6-1]
	\arrow["{E\otimes \rho_{E}\otimes S\otimes S^a}", from=5-3, to=5-2]
	\arrow["{E\otimes E\otimes S\otimes e\otimes S^a}", from=5-3, to=6-3]
	\arrow["{E\otimes E\otimes \phi_{a,-a}\otimes S\otimes S^a}", from=5-3, to=4-3]
	\arrow["{E\otimes E\otimes \phi_{a,-a}^{-1}\otimes E\otimes S^a}", from=6-4, to=6-3]
\end{tikzcd}\]
