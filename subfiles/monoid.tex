...
\end{lemma}
\begin{proof}
	Due to the size of the diagrams involved, we leave this as an exercise for the reader. It is entirely straightforward.
\end{proof}
...
\begin{lemma}\label{e_and_mu_are_monoid_homos}
    Let $(E,\mu,e)$ be a monoid object in $\cSH$. Then the map $e:S\to E$ is a monoid homomorphism. Furthermore, if $E$ is a \emph{commutative} monoid object, then $\mu:E\otimes E\to E$ is also a monoid object homomorphism. (Here $S$ and $E\otimes E$ are considered to be monoid objects by \autoref{unit_is_monoid} and \autoref{product_of_monoids_is_monoid}, respectively.)
\end{lemma}
\begin{proof}
	To see $e$ is a monoid homomorphism, consider the following diagrams:
	% https://q.uiver.app/#q=
	\[\begin{tikzcd}
		& S && {S\otimes S} && {E\otimes E} \\
		&&&& {S\otimes E} \\
		S && E & S && E
		\arrow["{e\otimes e}", from=1-4, to=1-6]
		\arrow["\mu", from=1-6, to=3-6]
		\arrow["{S\otimes e}"{description}, from=1-4, to=2-5]
		\arrow["{\rho_S=\lambda_S}"', from=1-4, to=3-4]
		\arrow["{e\otimes E}"{description}, from=2-5, to=1-6]
		\arrow["{\lambda_E}", from=2-5, to=3-6]
		\arrow["e"', from=3-4, to=3-6]
		\arrow[Rightarrow, no head, from=1-2, to=3-1]
		\arrow["e", from=3-1, to=3-3]
		\arrow["e", from=1-2, to=3-3]
	\end{tikzcd}\]
	The left diagram commutes by definition. The top region in the right diagram commutes by functoriality of $-\otimes-$. The right region commutes by unitality of $\mu$. The left region commutes by naturality of $\lambda$. Thus, indeed $e:S\to E$ is a monoid object homomorphism.

	Now, to see $\mu$ is a monoid object homomorphism when $(E,\mu,e)$ is a commutative monoid object, first consider the following diagram:
	% https://q.uiver.app/#q=WzAsNCxbMSwwLCJTIl0sWzAsMiwiRVxcb3RpbWVzIEUgIl0sWzIsMiwiRSJdLFsxLDEsIkUiXSxbMCwxLCJlXFxvdGltZXMgZSIsMl0sWzEsMiwiXFxtdSIsMl0sWzAsMiwiZSJdLFswLDMsImUiLDFdLFszLDEsIkVcXG90aW1lcyBlIl0sWzMsMiwiIiwxLHsibGV2ZWwiOjIsInN0eWxlIjp7ImhlYWQiOnsibmFtZSI6Im5vbmUifX19XV0=
	\[\begin{tikzcd}
		& S \\
		& E \\
		{E\otimes E } && E
		\arrow["{e\otimes e}"', from=1-2, to=3-1]
	...
	\end{tikzcd}\]
	The left region commutes by functoriality of $-\otimes-$, the right region commutes by definition, and the bottom region commutes by unitality of $\mu$. Now, consider the following diagram:
	% https://q.uiver.app/#q=
	\[\begin{tikzcd}
		{E_1\otimes E_2\otimes E_3\otimes E_4} &&& {E_{12}\otimes E_{34}} \\
		& {E_1\otimes E_{23}\otimes E_4} & {E_{12}\otimes E_3\otimes E_4} \\
		{E_1\otimes E_3\otimes E_2\otimes E_4} & {E_{13}\otimes E_2\otimes E_4} & {E_{123}\otimes E_4} \\
		{E_{13}\otimes E_{24}} &&& {E_{1234}}
		\arrow["\mu\otimes\mu", from=1-1, to=1-4]
		\arrow["\mu", from=1-4, to=4-4]
		\arrow["{E\otimes\tau\otimes E}"', from=1-1, to=3-1]
		\arrow["{\mu\otimes \mu}"', from=3-1, to=4-1]
		\arrow["\mu", from=4-1, to=4-4]
		\arrow["{E\otimes \mu\otimes E}"{description}, from=3-1, to=2-2]
		\arrow["{E\otimes\mu\otimes E}"', from=1-1, to=2-2]
		\arrow["{\mu\otimes E}"{description}, from=2-2, to=3-3]
		\arrow["\mu", from=3-3, to=4-4]
		\arrow["{\mu\otimes E\otimes E}", from=1-1, to=2-3]
		\arrow["{E\otimes \mu}"{description}, from=2-3, to=1-4]
		\arrow["{\mu\otimes E}"{description}, from=2-3, to=3-3]
		\arrow["{\mu\otimes E\otimes E}", from=3-1, to=3-2]
		\arrow["{E\otimes \mu}"{description}, from=3-2, to=4-1]
		\arrow["{\mu\otimes E}"', from=3-2, to=3-3]
	\end{tikzcd}\]
	Here we have numbered the $E$'s to make it clearer what's going on. The top and bottom left regions commute by functoriality of $-\otimes-$. The top left region commutes by commutativity of $\mu$. Every other region commutes by associativity of $\mu$. Thus, we've shown $\mu$ is a monoid object homomorphism, as desired.
\end{proof}
