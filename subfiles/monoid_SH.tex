...
\begin{definition}\label{R-GrCAlg_defn}
	Given an $A$-graded anticommutative ring $(R,\theta)$ (\autoref{A-graded_anticommutative_ring_defn}), we write $R\text-\GCA^{A}$ to denote the slice category $(R,\theta)/\GrCRing^{A}$. Explicitly:
    \begin{itemize}
