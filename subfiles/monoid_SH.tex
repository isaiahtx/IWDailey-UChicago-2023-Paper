...
For a review of monoid objects in a symmetric monoidal category, see \Cref{appendix:monoid_objects}. The most important example of a monoid object in $\cSH$ is the unit $S$, which has multiplication map $\phi_{0,0}^{-1}=\lambda_S=\rho_S:S\otimes S\to S$ and unit map $\id_S:S\to S$.
