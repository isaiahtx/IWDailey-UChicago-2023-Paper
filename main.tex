...
\title{The Motivic Adams spectral sequence}
...
\subfile{subfiles/1introduction.tex}
...
\section{(Co)algebra}\label{(co)algebra}

\subfile{subfiles/7coalgebra.tex}

\section{Monoid objects in a stable homotopy category}\label{monoid_objects}
